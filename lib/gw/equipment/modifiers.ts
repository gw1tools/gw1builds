...
export interface Modifier {
  ...
  pveOnly?: boolean
  /** Attribute this modifier affects (for "Of the X" mods) */
  attribute?: string
  /** Minimum attribute rank floor (for "Of the X" mods - uses Math.max, not additive) */
  minRank?: number
}
...
export const WEAPON_SUFFIXES: Modifier[] = [
  ...
  // Of the Warrior (Strength min 5)
  {
    id: 390,
    name: 'Axe Grip of the Warrior',
    category: 'suffix',
    weaponTypes: ['axe'],
    effect: 'Strength (min 5) (PvE only)',
    pveOnly: true,
    attribute: 'Strength',
    minRank: 5,
  },
  ...
  // Of the Ranger (Expertise min 5)
  {
    id: 400,
    name: 'Axe Grip of the Ranger',
    category: 'suffix',
    weaponTypes: ['axe'],
    effect: 'Expertise (min 5) (PvE only)',
    pveOnly: true,
    attribute: 'Expertise',
    minRank: 5,
  },
  ...
  // Of the Monk (Divine Favor min 5)
  {
    id: 410,
    name: 'Axe Grip of the Monk',
    category: 'suffix',
    weaponTypes: ['axe'],
    effect: 'Divine Favor (min 5) (PvE only)',
    pveOnly: true,
  ...
  // Of the Necromancer (Soul Reaping min 5)
  {
    id: 420,
    name: 'Axe Grip of the Necromancer',
    category: 'suffix',
    weaponTypes: ['axe'],
    effect: 'Soul Reaping (min 5) (PvE only)',
    pveOnly: true,
  ...
  // Of the Mesmer (Fast Casting min 5)
  {
    id: 430,
    name: 'Axe Grip of the Mesmer',
    category: 'suffix',
    weaponTypes: ['axe'],
    effect: 'Fast Casting (min 5) (PvE only)',
    pveOnly: true,
  ...
  // Of the Elementalist (Energy Storage min 5)
  {
    id: 440,
    name: 'Axe Grip of the Elementalist',
    category: 'suffix',
    weaponTypes: ['axe'],
    effect: 'Energy Storage (min 5) (PvE only)',
    pveOnly: true,
  ...
  // Of the Assassin (Critical Strikes min 5)
  {
    id: 450,
    name: 'Axe Grip of the Assassin',
    category: 'suffix',
    weaponTypes: ['axe'],
    effect: 'Critical Strikes (min 5) (PvE only)',
    pveOnly: true,
  ...
  // Of the Ritualist (Spawning Power min 5)
  {
    id: 460,
    name: 'Axe Grip of the Ritualist',
    category: 'suffix',
    weaponTypes: ['axe'],
    effect: 'Spawning Power (min 5) (PvE only)',
    pveOnly: true,
  ...
  // Of the Paragon (Leadership min 5)
  {
    id: 470,
    name: 'Axe Grip of the Paragon',
    category: 'suffix',
    weaponTypes: ['axe'],
    effect: 'Leadership (min 5) (PvE only)',
    pveOnly: true,
  ...
  // Of the Dervish (Mysticism min 5)
  {
    id: 480,
    name: 'Axe Grip of the Dervish',
    category: 'suffix',
    weaponTypes: ['axe'],
    effect: 'Mysticism (min 5) (PvE only)',
    pveOnly: true,
    attribute: 'Mysticism',
    minRank: 5,
  },
  ...
  // ============================================================================
  // "Of Slaying" Suffixes (PvE only)
  // Source: https://wiki.guildwars.com/wiki/Of_slaying
  // Note: IDs 500+ are internal IDs for display purposes (not game template IDs)
  // Available on: Axe Grip, Bow Grip, Hammer Grip, Sword Pommel, Staff Wrapping
  // ============================================================================

  // Of Charrslaying (vs. Charr)
  {
    id: 500,
    name: 'Axe Grip of Charrslaying',
    category: 'suffix',
    weaponTypes: ['axe'],
    effect: 'Damage +10-20% (vs. Charr)',
    pveOnly: true,
  },
  {
    id: 501,
    name: 'Bow Grip of Charrslaying',
    category: 'suffix',
    weaponTypes: ['bow'],
    effect: 'Damage +10-20% (vs. Charr)',
    pveOnly: true,
  ...
  {
    id: 502,
    name: 'Hammer Grip of Charrslaying',
    category: 'suffix',
    weaponTypes: ['hammer'],
    effect: 'Damage +10-20% (vs. Charr)',
    pveOnly: true,
  ...
  {
    id: 503,
    name: 'Sword Pommel of Charrslaying',
    category: 'suffix',
    weaponTypes: ['sword'],
    effect: 'Damage +10-20% (vs. Charr)',
    pveOnly: true,
  ...
  {
    id: 504,
    name: 'Staff Wrapping of Charrslaying',
    category: 'suffix',
    weaponTypes: ['staff'],
    effect: 'Damage +10-20% (vs. Charr)',
    pveOnly: true,
  ...
  // Of Demonslaying (vs. Demons)
  {
    id: 505,
    name: 'Axe Grip of Demonslaying',
    category: 'suffix',
    weaponTypes: ['axe'],
    effect: 'Damage +10-20% (vs. Demons)',
    pveOnly: true,
  },
  {
    id: 506,
    name: 'Bow Grip of Demonslaying',
    category: 'suffix',
    weaponTypes: ['bow'],
    effect: 'Damage +10-20% (vs. Demons)',
    pveOnly: true,
  ...
  {
    id: 507,
    name: 'Hammer Grip of Demonslaying',
    category: 'suffix',
    weaponTypes: ['hammer'],
    effect: 'Damage +10-20% (vs. Demons)',
    pveOnly: true,
  ...
  {
    id: 508,
    name: 'Sword Pommel of Demonslaying',
    category: 'suffix',
    weaponTypes: ['sword'],
    effect: 'Damage +10-20% (vs. Demons)',
    pveOnly: true,
  ...
  {
    id: 509,
    name: 'Staff Wrapping of Demonslaying',
    category: 'suffix',
    weaponTypes: ['staff'],
    effect: 'Damage +10-20% (vs. Demons)',
    pveOnly: true,
  ...
  // Of Dragonslaying (vs. Dragons)
  {
    id: 510,
    name: 'Axe Grip of Dragonslaying',
    category: 'suffix',
    weaponTypes: ['axe'],
    effect: 'Damage +10-20% (vs. Dragons)',
    pveOnly: true,
  },
  {
    id: 511,
    name: 'Bow Grip of Dragonslaying',
    category: 'suffix',
    weaponTypes: ['bow'],
    effect: 'Damage +10-20% (vs. Dragons)',
    pveOnly: true,
  ...
  {
    id: 512,
    name: 'Hammer Grip of Dragonslaying',
    category: 'suffix',
    weaponTypes: ['hammer'],
    effect: 'Damage +10-20% (vs. Dragons)',
    pveOnly: true,
  ...
  {
    id: 513,
    name: 'Sword Pommel of Dragonslaying',
    category: 'suffix',
    weaponTypes: ['sword'],
    effect: 'Damage +10-20% (vs. Dragons)',
    pveOnly: true,
  ...
  {
    id: 514,
    name: 'Staff Wrapping of Dragonslaying',
    category: 'suffix',
    weaponTypes: ['staff'],
    effect: 'Damage +10-20% (vs. Dragons)',
    pveOnly: true,
  ...
  // Of Dwarfslaying (vs. Dwarves)
  {
    id: 515,
    name: 'Axe Grip of Dwarfslaying',
    category: 'suffix',
    weaponTypes: ['axe'],
    effect: 'Damage +10-20% (vs. Dwarves)',
    pveOnly: true,
  },
  {
    id: 516,
    name: 'Bow Grip of Dwarfslaying',
    category: 'suffix',
    weaponTypes: ['bow'],
    effect: 'Damage +10-20% (vs. Dwarves)',
    pveOnly: true,
  ...
  {
    id: 517,
    name: 'Hammer Grip of Dwarfslaying',
    category: 'suffix',
    weaponTypes: ['hammer'],
    effect: 'Damage +10-20% (vs. Dwarves)',
    pveOnly: true,
  ...
  {
    id: 518,
    name: 'Sword Pommel of Dwarfslaying',
    category: 'suffix',
    weaponTypes: ['sword'],
    effect: 'Damage +10-20% (vs. Dwarves)',
    pveOnly: true,
  ...
  {
    id: 519,
    name: 'Staff Wrapping of Dwarfslaying',
    category: 'suffix',
    weaponTypes: ['staff'],
    effect: 'Damage +10-20% (vs. Dwarves)',
    pveOnly: true,
  ...
  // Of Giantslaying (vs. Giants)
  {
    id: 520,
    name: 'Axe Grip of Giantslaying',
    category: 'suffix',
    weaponTypes: ['axe'],
    effect: 'Damage +10-20% (vs. Giants)',
    pveOnly: true,
  },
  {
    id: 521,
    name: 'Bow Grip of Giantslaying',
    category: 'suffix',
    weaponTypes: ['bow'],
    effect: 'Damage +10-20% (vs. Giants)',
    pveOnly: true,
  ...
  {
    id: 522,
    name: 'Hammer Grip of Giantslaying',
    category: 'suffix',
    weaponTypes: ['hammer'],
    effect: 'Damage +10-20% (vs. Giants)',
    pveOnly: true,
  ...
  {
    id: 523,
    name: 'Sword Pommel of Giantslaying',
    category: 'suffix',
    weaponTypes: ['sword'],
    effect: 'Damage +10-20% (vs. Giants)',
    pveOnly: true,
  ...
  {
    id: 524,
    name: 'Staff Wrapping of Giantslaying',
    category: 'suffix',
    weaponTypes: ['staff'],
    effect: 'Damage +10-20% (vs. Giants)',
    pveOnly: true,
  ...
  // Of Ogreslaying (vs. Ogres)
  {
    id: 525,
    name: 'Axe Grip of Ogreslaying',
    category: 'suffix',
    weaponTypes: ['axe'],
    effect: 'Damage +10-20% (vs. Ogres)',
    pveOnly: true,
  },
  {
    id: 526,
    name: 'Bow Grip of Ogreslaying',
    category: 'suffix',
    weaponTypes: ['bow'],
    effect: 'Damage +10-20% (vs. Ogres)',
    pveOnly: true,
  ...
  {
    id: 527,
    name: 'Hammer Grip of Ogreslaying',
    category: 'suffix',
    weaponTypes: ['hammer'],
    effect: 'Damage +10-20% (vs. Ogres)',
    pveOnly: true,
  ...
  {
    id: 528,
    name: 'Sword Pommel of Ogreslaying',
    category: 'suffix',
    weaponTypes: ['sword'],
    effect: 'Damage +10-20% (vs. Ogres)',
    pveOnly: true,
  ...
  {
    id: 529,
    name: 'Staff Wrapping of Ogreslaying',
    category: 'suffix',
    weaponTypes: ['staff'],
    effect: 'Damage +10-20% (vs. Ogres)',
    pveOnly: true,
  ...
  // Of Pruning (vs. Plants)
  {
    id: 530,
    name: 'Axe Grip of Pruning',
    category: 'suffix',
    weaponTypes: ['axe'],
    effect: 'Damage +10-20% (vs. Plants)',
    pveOnly: true,
  },
  {
    id: 531,
    name: 'Bow Grip of Pruning',
    category: 'suffix',
    weaponTypes: ['bow'],
    effect: 'Damage +10-20% (vs. Plants)',
    pveOnly: true,
  ...
  {
    id: 534,
    name: 'Staff Wrapping of Pruning',
    category: 'suffix',
    weaponTypes: ['staff'],
    effect: 'Damage +10-20% (vs. Plants)',
    pveOnly: true,
  ...
  // Of Tenguslaying (vs. Tengu)
  {
    id: 535,
    name: 'Axe Grip of Tenguslaying',
    category: 'suffix',
    weaponTypes: ['axe'],
    effect: 'Damage +10-20% (vs. Tengu)',
    pveOnly: true,
  },
  {
    id: 536,
    name: 'Bow Grip of Tenguslaying',
    category: 'suffix',
    weaponTypes: ['bow'],
    effect: 'Damage +10-20% (vs. Tengu)',
    pveOnly: true,
  ...
  {
    id: 537,
    name: 'Hammer Grip of Tenguslaying',
    category: 'suffix',
    weaponTypes: ['hammer'],
    effect: 'Damage +10-20% (vs. Tengu)',
    pveOnly: true,
  ...
  {
    id: 538,
    name: 'Sword Pommel of Tenguslaying',
    category: 'suffix',
    weaponTypes: ['sword'],
    effect: 'Damage +10-20% (vs. Tengu)',
    pveOnly: true,
  ...
  {
    id: 539,
    name: 'Staff Wrapping of Tenguslaying',
    category: 'suffix',
    weaponTypes: ['staff'],
    effect: 'Damage +10-20% (vs. Tengu)',
    pveOnly: true,
  ...
  // Of Trollslaying (vs. Trolls)
  {
    id: 540,
    name: 'Axe Grip of Trollslaying',
    category: 'suffix',
    weaponTypes: ['axe'],
    effect: 'Damage +10-20% (vs. Trolls)',
    pveOnly: true,
  },
  {
    id: 541,
    name: 'Bow Grip of Trollslaying',
    category: 'suffix',
    weaponTypes: ['bow'],
    effect: 'Damage +10-20% (vs. Trolls)',
    pveOnly: true,
  ...
  {
    id: 542,
    name: 'Hammer Grip of Trollslaying',
    category: 'suffix',
    weaponTypes: ['hammer'],
    effect: 'Damage +10-20% (vs. Trolls)',
    pveOnly: true,
  ...
  {
    id: 543,
    name: 'Sword Pommel of Trollslaying',
    category: 'suffix',
    weaponTypes: ['sword'],
    effect: 'Damage +10-20% (vs. Trolls)',
    pveOnly: true,
  ...
  {
    id: 544,
    name: 'Staff Wrapping of Trollslaying',
    category: 'suffix',
    weaponTypes: ['staff'],
    effect: 'Damage +10-20% (vs. Trolls)',
    pveOnly: true,
  ...
  // Of Deathbane (vs. Undead)
  {
    id: 545,
    name: 'Axe Grip of Deathbane',
    category: 'suffix',
    weaponTypes: ['axe'],
    effect: 'Damage +10-20% (vs. Undead)',
    pveOnly: true,
  },
  {
    id: 546,
    name: 'Bow Grip of Deathbane',
    category: 'suffix',
    weaponTypes: ['bow'],
    effect: 'Damage +10-20% (vs. Undead)',
    pveOnly: true,
  ...
  {
    id: 548,
    name: 'Sword Pommel of Deathbane',
    category: 'suffix',
    weaponTypes: ['sword'],
    effect: 'Damage +10-20% (vs. Undead)',
    pveOnly: true,
  ...
  {
    id: 549,
    name: 'Staff Wrapping of Deathbane',
    category: 'suffix',
    weaponTypes: ['staff'],
    effect: 'Damage +10-20% (vs. Undead)',
    pveOnly: true,
  ...
  // Of Skeletonslaying (vs. Skeletons)
  {
    id: 550,
    name: 'Axe Grip of Skeletonslaying',
    category: 'suffix',
    weaponTypes: ['axe'],
    effect: 'Damage +10-20% (vs. Skeletons)',
    pveOnly: true,
  },
  {
    id: 551,
    name: 'Bow Grip of Skeletonslaying',
    category: 'suffix',
    weaponTypes: ['bow'],
    effect: 'Damage +10-20% (vs. Skeletons)',
    pveOnly: true,
  ...
  {
    id: 552,
    name: 'Hammer Grip of Skeletonslaying',
    category: 'suffix',
    weaponTypes: ['hammer'],
    effect: 'Damage +10-20% (vs. Skeletons)',
    pveOnly: true,
  ...
  {
    id: 553,
    name: 'Sword Pommel of Skeletonslaying',
    category: 'suffix',
    weaponTypes: ['sword'],
    effect: 'Damage +10-20% (vs. Skeletons)',
    pveOnly: true,
  ...
  {
    id: 554,
    name: 'Staff Wrapping of Skeletonslaying',
    category: 'suffix',
    weaponTypes: ['staff'],
    effect: 'Damage +10-20% (vs. Skeletons)',
    pveOnly: true,
