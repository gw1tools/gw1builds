...
export const WANDS: EquipmentItem[] = [
  // Mesmer
  { id: 134, name: 'PvP Cane', type: 'wand', slot: 0, attribute: 'Fast Casting' },
  {
    id: 135,
  ...
  // Additional wands (from later IDs)
  {
    id: 326,
